...
var HistoryComponent = (function () {
    function HistoryComponent() {
        ...
        this.summer_2012 = "Orion begins around a kitchen table with a group of "
        ...
        this.october_2012 = "Orion officially opens in a small office in Troy, "
            + "Michigan. We received our first orders for "
            + "professional search and contract staffing within "
            + "a couple weeks.";
        this.november_2012 = "Orion successfully closes our first staffing job "
        ...
        this.april_2013 = "Orion doubles our office space from one small office "
            + "to two small offices – now our entire team could "
            + "actually be on site at the same time.";
        this.may_2013 = "Orion reaches the milestone of our 100 th order!";
        this.september_2013 = "Orion continues to grow and we moved to a much "
            + "larger space. Now everyone got to have their "
            + "own office!";
        this.january_2014 = "Orion completes the first full year in business "
            + "as a profitable, cash positive business! All that "
            + "while carrying no debt.";
        this.april_2014 = "Partner and Co-Founder Dave Flynn is featured on a "
            + "news story for the Detroit NBC affiliate, WDIV ";
        this.april_2014_a = "http://www.clickondetroit.com/news/clinton-township-woman-says-email-cost-her-new-job/25286652";
        this.january_2015 = "Orion finishes another strong year with revenue "
            + "growth, profitability and no debt. Orion takes on "
            + "our 500 th order.";
        this.february_2015 = "During one of the coldest winters on record, Orion’s "
        ...
        this.september_2015 = "Orion continues to add staff and has a build out "
            + "in our space to add three additional offices.";
        this.january_2016 = "Orion does it again and finishes the year "
            + "profitably and with no debt.";
        this.august_2016 = "Orion receives our 1000 th order.";
        this.summer_2016 = "Orion starts our college internship program. Our "
        ...
        this.january_2017 = "The streak continues as Orion completes our "
            + "fourth year in business profitably and with no debt.";
        this.october_2017 = "Orion joins the Finance and Accounting Consultants Alliance "
        ...
        this.january_2018 = "Orion caps off another successful year!  2017 saw a 50% "
